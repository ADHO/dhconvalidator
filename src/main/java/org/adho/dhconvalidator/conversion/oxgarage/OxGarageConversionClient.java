...
public class OxGarageConversionClient {
  ...
  public String convertToString(
      byte[] sourceData, ConversionPath conversionPath, Properties properties) throws IOException {
  ...
  public InputStream convert(
      final byte[] sourceData, ConversionPath conversionPath, Properties properties)
      throws IOException {
  ...
  private InputStream convert(
      Representation sourceRep, ConversionPath conversionPath, Properties properties)
      throws IOException {
  ...
  private String convertToString(File file, ConversionPath conversionPath, Properties properties)
      throws IOException {
   ...
   * @throws IOException in case of any failure
   */
  private InputStream convert(File file, ConversionPath conversionPath, Properties properties)
      throws IOException {
