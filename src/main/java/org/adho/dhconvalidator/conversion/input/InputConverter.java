...
public interface InputConverter {
  ...
  /**
   * Receives an input file in one of the supported formats, makes adjustments and returns the
   * modified data in the original format.
   *
  ...
  /**
   * @return the paper that gets loaded during conversion or <code>null</code> if not yet available
   *     (prior to conversion)
   */
