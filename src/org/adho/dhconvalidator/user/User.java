...
public class User {
  ...
  /**
   * Detailed user as delivered by {@link ExportType#users} and copy constructor for user switching.
   *
   * @param userId
   * @param userName
   * @param firstName
   ...
   * @param admin
   */
  public User(Integer userId, String firstName, String lastName, String email, boolean admin) {
    super();
    this.userId = userId;
    this.firstName = firstName;
    this.lastName = lastName;
   ...
   * @param email
   */
  public User(String firstName, String lastName, String organizations, String email) {
    super();
    this.firstName = firstName;
    this.lastName = lastName;
